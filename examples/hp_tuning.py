...
def run_hp_sweep(cfg: DictConfig):
    results = {}
    for n_kfac in [1, 2, 4, 8, 16, 32]:
        res = main(cfg, n_kfac)
        results[n_kfac] = res
...
"""
{1: {'NLL': 1.6060681636904326, 'ACC': 0.27112674713134766, 'ECE': 0.031277820467948914}, 
2: {'NLL': 1.6053284129626315, 'ACC': 0.246478870511055, 'ECE': 0.01245614979416132}, 
4: {'NLL': 1.6126943793095334, 'ACC': 0.19366197288036346, 'ECE': 0.10514336079359055}, 
8: {'NLL': 1.6124172999825277, 'ACC': 0.2059859186410904, 'ECE': 0.10580773651599884}, 
16: {'NLL': 1.6120964817597832, 'ACC': 0.2095070481300354, 'ECE': 0.11063730716705322}, 
32: {'NLL': 1.612365075400178, 'ACC': 0.20070423185825348, 'ECE': 0.10877497494220734}}
"""
...
def main(cfg, n_kfac):
    ...
    if False: #  not os.path.exists(map_param_path) or cfg.run_every_step:
        # setup optimiser
    ...
    if False: #  not os.path.exists(ll_path) or cfg.run_every_step:
